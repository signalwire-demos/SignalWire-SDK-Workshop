// Step 10: Built-in Skills (TypeScript sibling, reference-only)
// Matches python/steps/step10_skills.py.
//
// New concepts:
//   - addSkill(): one line, instant capability
...
export class SkillsAgent extends AgentBase {
  constructor(route = "/") {
    super({ name: "skills-agent", route });
