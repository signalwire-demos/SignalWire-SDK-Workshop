// Step 9: Polish and Personality (TypeScript sibling, reference-only)
// Matches python/steps/step09_polish.py.
//
// New concepts:
//   - setParams(): tune conversation timing (speech timeout, attention timeout)
//   - addHints(): help the speech recognizer with tricky words
...
export class PolishedAgent extends AgentBase {
  constructor(route = "/") {
    super({ name: "polished-agent", route });
    ...
    this.addHints(["Buddy", "weather", "joke", "temperature", "forecast"]);
